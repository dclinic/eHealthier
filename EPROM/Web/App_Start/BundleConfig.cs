...
namespace ePRom
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new StyleBundle("~/bundles/ot-js").Include(
               "~/Resources/scripts/App/OTController.js"
           ));

            bundles.Add(new StyleBundle("~/bundles/add-ot-js").Include(
             "~/Resources/scripts/App/AddOTController.js"
         ));

            bundles.Add(new StyleBundle("~/bundles/ut-js").Include(
               "~/Resources/scripts/App/UTController.js"
           ));

            bundles.Add(new StyleBundle("~/bundles/add-ut-js").Include(
             "~/Resources/scripts/App/AddUTController.js"
         ));
